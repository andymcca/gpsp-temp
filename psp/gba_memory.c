...
{                                                                             \
  ...
  gbc_sound_channel[channel].frequency_step = float_to_fp16_16(            \
    ((131072.0 / (2048 - rate)) * 8.0) / sound_frequency);                  \
...
{                                                                             \
  ...
  gbc_sound_channel[2].frequency_step = float_to_fp16_16(                  \
    (2097152.0 / (2048 - rate)) / sound_frequency);                         \
